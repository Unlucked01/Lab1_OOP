...
class TrainStation
{
    ...
    public double ticketsSold { get; set; } // Число проданных билетов
    ...
    public TrainStation(string stationName, int seatsNumber, double ticketsSold, string location, int trainsPerDay, decimal averageTicketPrice, bool hasWiFi)
    {
        this.stationName = stationName;
        this.seatsNumber = seatsNumber;
